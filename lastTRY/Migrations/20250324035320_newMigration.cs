    ...
    public partial class newMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Rock", "Rock Classics" });

            migrationBuilder.InsertData(
                table: "Albums",
                columns: new[] { "Id", "ArtistId", "Genre", "Name", "Rating", "Year" },
                values: new object[,]
                {
                    { 1, 1, "Rock", "A Night at the Opera", 0, 1975 },
                    { 2, 2, "Grunge", "Nevermind", 0, 1991 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new TimeSpan(0, 0, 5, 55, 0), null, "Bohemian Rhapsody", 0, 0 },
                    { 2, 2, new TimeSpan(0, 0, 5, 1, 0), null, "Smells Like Teen Spirit", 0, 0 }
                });
